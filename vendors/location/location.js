...
// var verify = (local != 'pr') || (local != 'illinois') || (local != 'florida') || (local != 'georgia') || (local == null) || (local == undefined) || (local == 0) || (local == '') || (local == NaN);  
var verify = (local != 'illinois') || (local != 'florida') || (local != 'georgia') || (local == null) || (local == undefined) || (local == 0) || (local == '') || (local == NaN);  
// if((local === 'pr') || (local === 'illinois') || (local === 'florida') || (local === 'georgia')){
if((local === 'illinois') || (local === 'florida') || (local === 'georgia')){
